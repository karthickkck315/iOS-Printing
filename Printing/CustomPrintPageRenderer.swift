...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
       ...
       let textSize = getTextSize(text: headerText as String, font: nil, textAttributes: textAttributes as? [NSAttributedString.Key : Any])
        ...
        headerText.draw(at: CGPoint(x: pointX, y: pointY), withAttributes: textAttributes as? [NSAttributedString.Key : Any])
    }
    ...
    override func drawFooterForPage(at pageIndex: Int, in footerRect: CGRect) {
        ...
        let textSize = getTextSize(text: footerText as String, font: font, textAttributes: [:])
    ...
    func getTextSize(text: String, font: UIFont!, textAttributes: [NSAttributedString.Key : Any]?) -> CGSize {
